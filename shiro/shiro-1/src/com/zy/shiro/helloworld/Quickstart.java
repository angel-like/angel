...
public class Quickstart {
    ...
    public static void main(String[] args) {
        ...
        //test a role:
     // 3.测试是否有某一个角色. 调用 Subject 的 hasRole 方法.  
        ...
        // 4.测试用户是否具备某一个行为. 调用 Subject 的 isPermitted() 方法。    
        /**
         * 使用注解方式 
         * @RequiresPermissions("sys:student:list")
         * //权限校验，要求subject中含有sys:student:list的权限才能执行方法下面这个方法
         */
        if (currentUser.isPermitted("lightsaber:anything")) {
