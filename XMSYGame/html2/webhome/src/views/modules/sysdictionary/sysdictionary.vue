<template>
  <div class="mod-config">
    <el-form :inline="true" :model="dataForm" @submit.native.prevent @keyup.enter.native="getDataList()">
      <el-form-item>
        <el-input v-model="dataForm.code" placeholder="代码" clearable></el-input>
      </el-form-item>
      <el-form-item>
		...
		<div v-if="dataForm.parentCode!='0'"> 
				...
				<el-button @click="backLevelHandle()">返回上一级</el-button>
		</div>
    <el-table
      :data="dataList"
      border
      ...
      <el-table-column
        ...
        label="名称">
				<template slot-scope="scope">
					...
					<el-button v-else type="text" size="small" @click="nextLevelHandle(scope.row.code,scope.row.name,scope.row.parentCode)">{{scope.row.name}}</el-button>
				</template>
      </el-table-column>
      <el-table-column
        prop="parentCode"
