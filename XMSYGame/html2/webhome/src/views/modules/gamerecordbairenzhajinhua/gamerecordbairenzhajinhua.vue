...
<script>
  import AddOrUpdate from './gamerecordbairenzhajinhua-add-or-update'
 ...
 export default {
    ...
    methods: {
      ...
      getDataList () {
        ...
        this.$http({
          url: this.$http.adornUrl('/gamerecordzhajinhua/gamerecordzhajinhua/list'),
          method: 'get',
      ...
      deleteHandle (id) {
        ...
        this.$confirm(`确定对[id=${ids.join(',')}]进行[${id ? '删除' : '批量删除'}]操作?`, '提示', {
          ...
          this.$http({
            url: this.$http.adornUrl('/gamerecordzhajinhua/gamerecordzhajinhua/delete'),
            method: 'post',
