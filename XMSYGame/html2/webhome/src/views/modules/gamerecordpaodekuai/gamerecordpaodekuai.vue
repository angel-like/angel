    ...
    <el-form-item>
     ...
     <el-table
      ...
      <el-table-column
        ...
        label="包赔数">
				<template slot-scope="scope">
					<div v-if="scope.row.compensateNum==0">无</div>
					<div v-if="scope.row.compensateNum!=0">{{scope.row.compensateNum}}</div>
				</template>
      </el-table-column>
      <el-table-column
        prop="prizeCoins"
  ...
  export default {
    ...
    methods: {
      ...
      getDataList () {
        ...
        this.$http({
          url: this.$http.adornUrl('/gamerecordpaodekuai/gamerecordpaodekuai/list'),
          method: 'get',
      ...
      deleteHandle (id) {
        ...
        this.$confirm(`确定对[id=${ids.join(',')}]进行[${id ? '删除' : '批量删除'}]操作?`, '提示', {
          ...
          this.$http({
            url: this.$http.adornUrl('/gamerecordpaodekuai/gamerecordpaodekuai/delete'),
            method: 'post',
