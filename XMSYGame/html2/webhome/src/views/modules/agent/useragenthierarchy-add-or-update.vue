<template>
  <el-dialog
    ...
    <el-form :model="dataForm" :rules="dataRule" ref="dataForm" @keyup.enter.native="dataFormSubmit()" label-width="80px">
      ...
      <el-tooltip class="item" effect="dark" content="代理下线实名赠送给代理商的金币(单位:元)" placement="top-start">
        <el-form-item label="金币" prop="coin">
          <el-input v-model="dataForm.coin" placeholder="整数" clearable></el-input>
        </el-form-item>
      </el-tooltip>
          ...
          if (this.dataForm.id) {
            this.$http({
              ...
              if (data && data.code === 200) {
                ...
                this.dataForm.coin = (data.useragenthierarchy.coin)/100
              }
            })
          }
        })
