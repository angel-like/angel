	...
	<div class="mod-config">
		<el-tabs v-model="activeName" @tab-click="handleClick()">
			<el-tab-pane label="订单列表" name="first">
				...
				<div style="color: red;margin-bottom: 10px;">取款笔数总计：{{takeMoneyNum}}    &nbsp;&nbsp;&nbsp;取款金额总计：{{takeMoneytotal}}</div>
				<el-table :data="dataList" border v-loading="dataListLoading" @selection-change="selectionChangeHandle" style="width: 100%;">
					...
					<el-table-column prop="userAccount" header-align="center" align="center" label="取款用户账号">
						<template slot-scope="scope">
							<a  @click="read(scope.row)" title="查看详情" style="cursor:pointer ">{{scope.row.userAccount}}</a>
						</template>
					</el-table-column>
					...
					<el-table-column prop="userSurplusCoin" header-align="center" align="center" label="用户剩余金额">
						<template slot-scope="scope">
			...
			<el-tab-pane label="处理订单" name="work">
