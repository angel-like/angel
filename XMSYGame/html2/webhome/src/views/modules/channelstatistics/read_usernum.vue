	...
	<el-dialog :title="'详情'" :close-on-click-modal="false" :visible.sync="visible">
		<div class="mod-config">
			...
			<el-table :data="dataList" border v-loading="dataListLoading" @selection-change="selectionChangeHandle" style="width: 100%;">
				...
				<el-table-column prop="uservalidBet" header-align="center" align="center" label="会员打码量">
					<template slot-scope="scope">
						<div>{{scope.row.uservalidBet/100}}</div>
					</template>
				</el-table-column>
			</el-table>
	...
	export default {
		...
		methods: {
			...
			getDataList() {
				...
				//console.log("开始时间:"+this.dataForm.startTime+"结束时间："+this.dataForm.endTime)
				this.$http({
					url: this.$http.adornUrl('/channelstatistics/channelstatistics/listusernum'),
					method: 'get',
