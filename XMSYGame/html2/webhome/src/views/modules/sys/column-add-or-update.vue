  ...
  <el-dialog
    ...
    :visible.sync="visible">
		<div style="margin: -64px 60px 40px 60px;">
				<el-tooltip class="item" effect="dark" content="点击图片,跳转的url" placement="top">
    ...
    <el-form :model="dataForm" :rules="dataRule" ref="dataForm" @keyup.enter.native="dataFormSubmit()" label-width="80px">
      ...
      <el-form-item label="上级栏目" prop="parentName">
        <el-popover
          ...
          trigger="click">
					<div class="scrollnone" style="overflow: auto; height: 400px;">
          <el-tree
            :data="menuList"
        ...
        <el-row>
          <el-col :span="22">
            <el-popover
              ...
              placement="bottom-start"
              trigger="click"
              popper-class="mod-menu__icon-popover" height="400px">
            ...
            <el-input v-model="dataForm.icon" v-popover:iconListPopover :readonly="true" placeholder="栏目图标名称" class="icon-list__input"></el-input>
          </el-col>
  ...
  export default {
    ...
    methods: {
      init (id) {
        ...
        this.$http({
          url: this.$http.adornUrl('/sys/column/select'),
          method: 'get',
          ...
          if (!this.dataForm.id) {
            ...
            // 修改
            this.$http({
              url: this.$http.adornUrl(`/sys/column/info/${this.dataForm.id}`),
              method: 'get',
              params: this.$http.adornParams()
            }).then(({data}) => {
      ...
      dataFormSubmit () {
        this.$refs['dataForm'].validate((valid) => {
          if (valid) {
            this.$http({
              url: this.$http.adornUrl(`/sys/column/${!this.dataForm.id ? 'save' : 'update'}`),
              method: 'post',
