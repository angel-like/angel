  ...
  export default {
    ...
    methods: {
      ...
      getDataList() {
        ...
        this.$http({
          url: this.$http.adornUrl('/gamerecordcattlqiangzhuang/gamerecordcattlqiangzhuang/list'),
          method: 'get',
      ...
      deleteHandle(id) {
        ...
        this.$confirm(`确定对[id=${ids.join(',')}]进行[${id ? '删除' : '批量删除'}]操作?`, '提示', {
          ...
          this.$http({
            url: this.$http.adornUrl('/gamerecordcattlqiangzhuang/gamerecordcattlqiangzhuang/delete'),
            method: 'post',
