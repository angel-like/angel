    ...
    <div class="mod-config">
      <el-form :inline="true" :model="dataForm" @keyup.enter.native="getDataList()">
        ...
        <el-form-item>
          ...
          <!-- <el-button v-if="isAuth('enveloperecord:enveloperecord:save')" type="primary" @click="addOrUpdateHandle()">新增</el-button>
  ...
  export default {
    ...
    methods: {
      ...
      getDataList() {
        ...
        this.$http({
          url: this.$http.adornUrl('/enveloperecord/enveloperecord/count'),
          method: 'get',
