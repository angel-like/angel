  ...
  <div class="mod-config">
    <el-form :inline="true" :model="dataForm" @submit.native.prevent @keyup.enter.native="getDataList()">
      ...
      <el-form-item>
        ...
        <!-- <el-button v-if="isAuth('gamerecordfightlandlords:gamerecordfightlandlords:save')" type="primary" @click="addOrUpdateHandle()">新增</el-button> -->
        <!-- <el-button v-if="isAuth('gamerecordfightlandlords:gamerecordfightlandlords:delete')" type="danger" @click="deleteHandle()" :disabled="dataListSelections.length <= 0">批量删除</el-button> -->
      </el-form-item>
    </el-form>
    <el-table
      :data="dataList"
      ...
      <el-table-column
        ...
        label="操作">
        <template slot-scope="scope">
          <el-button type="text" size="small" @click="infoHandle(scope.row.gameRoundNo)">查看详情</el-button>
        </template>
      </el-table-column>
    </el-table>
    <el-pagination
...
<script>
  import AddOrUpdate from './gamerecordfightlandlords-add-or-update';
  import info from './gamerecordfightlandlords-info';
  ...
  export default {
    ...
    methods: {
      ...
      getDataList() {
        ...
        this.$http({
          url: this.$http.adornUrl('/gamerecordfightlandlords/gamerecordfightlandlords/list'),
          method: 'get',
      ...
      // 查看详情
      infoHandle(gameRoundNo) {
        this.infoVisible = true
        this.$nextTick(() => {
          this.$refs.info.init(gameRoundNo)
        })
      },
      // 新增 / 修改
      ...
      deleteHandle(id) {
        ...
        this.$confirm(`确定对[id=${ids.join(',')}]进行[${id ? '删除' : '批量删除'}]操作?`, '提示', {
          ...
          this.$http({
            url: this.$http.adornUrl('/gamerecordfightlandlords/gamerecordfightlandlords/delete'),
            method: 'post',
