    ...
    <el-form :inline="true" :model="dataForm" @keyup.enter.native="getDataList()">
      <el-form-item>
        <el-date-picker v-model="dataForm.queryTime" type="datetimerange" align="right" unlink-panels
                        range-separator="至"
                        start-placeholder="开始日期" end-placeholder="结束日期" :picker-options="pickerOptions2" :default-time="['00:00:00', '23:59:59']" value-format="yyyy-MM-dd HH:mm:ss">
        </el-date-picker>
      </el-form-item>
      <el-form-item>
    ...
    <el-table
      ...
      <el-table-column
           ...
           <el-table-column
             ...
             align="center"
             label="游戏开始时间">
             <template value-format="yyyy-MM-dd HH:mm:ss"></template>
           </el-table-column>
           <el-table-column
             prop="gameEndTime"
             header-align="center"
  ...
  export default {
   ...
   methods: {
     ...
     getDataList () {
        ...
        this.$http({
          url: this.$http.adornUrl('/gamerecordkaiyuan/gamerecordkaiyuan/list/gangshisuoha'),
          method: 'get',
