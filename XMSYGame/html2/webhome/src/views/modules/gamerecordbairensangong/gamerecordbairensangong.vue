    ...
    <el-table
      ...
      <el-table-column
        ...
        <template slot-scope="scope">
          <div>{{scope.row.gradeName}}-{{scope.row.gradeNumber}}</div>
        </template>
      </el-table-column>
      <!-- <el-table-column
          prop="coinsBefore"
      ...
      <el-table-column
        ...
        label="倍数模式">
        <template slot-scope="scope">
          <div v-if="scope.row.multipleType==1">平倍模式</div>
          <div v-if="scope.row.multipleType==2">翻倍模式</div>
        </template>
      </el-table-column>
      <el-table-column
        prop="createTime"
...
<script>
  import AddOrUpdate from './gamerecordbairensangong-add-or-update'
  ...
  export default {
    ...
    methods: {
      ...
      getDataList() {
        ...
        this.$http({
          url: this.$http.adornUrl('/gamerecordbairensangong/gamerecordbairensangong/list'),
          method: 'get',
      ...
      deleteHandle(id) {
        ...
        this.$confirm(`确定对[id=${ids.join(',')}]进行[${id ? '删除' : '批量删除'}]操作?`, '提示', {
          ...
          this.$http({
            url: this.$http.adornUrl('/gamerecordbairensangong/gamerecordbairensangong/delete'),
            method: 'post',
