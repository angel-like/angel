  ...
  <div class="mod-config">
    <el-form :inline="true" :model="dataForm" @submit.native.prevent @keyup.enter.native="getDataList()">
      ...
      <el-form-item>
        ...
        <el-button v-if="isAuth('imgameranking:imgameranking:save')" type="primary" @click="addOrUpdateHandle()">新增</el-button>
        <el-button v-if="isAuth('imgameranking:imgameranking:delete')" type="danger" @click="deleteHandle()" :disabled="dataListSelections.length <= 0">批量删除</el-button>
      </el-form-item>
    </el-form>
    <el-table
      :data="dataList"
...
<script>
  import AddOrUpdate from './imgameranking-add-or-update'
  export default {
    data () {
      return {
        dataForm: {
    ...
    methods: {
      ...
      getDataList () {
        ...
        this.$http({
          url: this.$http.adornUrl('/imgameranking/imgameranking/list'),
          method: 'get',
      ...
      selectionChangeHandle (val) {
        this.dataListSelections = val
			...
			updateEnable(id,enable) {
				this.$http({
					url: this.$http.adornUrl('/imgameranking/imgameranking/updateEnable'),
					method: 'get',
					params: this.$http.adornParams({
						'id': id,
						'enable': enable
      ...
      deleteHandle (id) {
        ...
        this.$confirm(`确定对[id=${ids.join(',')}]进行[${id ? '删除' : '批量删除'}]操作?`, '提示', {
          ...
          this.$http({
            url: this.$http.adornUrl('/imgameranking/imgameranking/delete'),
            method: 'post',
