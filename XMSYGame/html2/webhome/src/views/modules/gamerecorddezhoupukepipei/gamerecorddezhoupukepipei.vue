    ...
    <el-table
      ...
      <el-table-column
        ...
        <template slot-scope="scope">
          <div>
            {{scope.row.bigBaseScore/100}}/{{scope.row.smallBaseScore/100}}
          </div>
        </template>
      </el-table-column>
      <el-table-column
  ...
  export default {
    ...
    methods: {
      ...
      getDataList() {
        ...
        this.$http({
          url: this.$http.adornUrl('/gamerecorddezhoupuke/gamerecorddezhoupuke/list'),
          method: 'get',
      ...
      deleteHandle(id) {
        ...
        this.$confirm(`确定对[id=${ids.join(',')}]进行[${id ? '删除' : '批量删除'}]操作?`, '提示', {
          ...
          this.$http({
            url: this.$http.adornUrl('/gamerecorddezhoupuke/gamerecorddezhoupuke/delete'),
            method: 'post',
