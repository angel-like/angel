  ...
  <div class="mod-demo-ueditor">
    <el-alert
      ...
      <div slot-scope="description">
        <p class="el-alert__description">1. 111111此Demo只提供UEditor官方使用文档，入门部署和体验功能。具体使用请参考：http://fex.baidu.com/ueditor/</p>
...
<script>
  ...
  export default {
    ...
    mounted () {
			console.log(ueditor.getEditor(this.ueId).getContent)
