...
<script>
	...
	import addOrUpdateAll from '../gameconfig/gameconfig-add-or-update-all'
	import intervalGameRate from '../gameconfig/gameconfig-add-or-update-interval'
	import addOrUpdatePerfect from '../gameconfig/gameconfig-add-or-update-perfect'
	export default {
		data() {
			return {
				dataForm: {
