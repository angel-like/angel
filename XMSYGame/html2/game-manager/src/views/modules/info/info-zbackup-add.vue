<template>
  <el-dialog
    ...
    <el-form-item label="游戏名字" prop="gameName">
      <el-input v-model="dataForm.gameName" placeholder="游戏名字"></el-input>
		...
		<el-form-item label="游戏场次" prop="gradeId">
			...
			<el-form-item label="维护" prop="maintenance">
    ...
    <el-form-item label="游戏低分" prop="bscore">
      <el-input v-model="dataForm.bscore" placeholder="只能输入数字"></el-input>
    </el-form-item>
    <el-form-item label="入场限制" prop="restrict">
      <el-input v-model="dataForm.restrict" placeholder="只能输入数字"></el-input>
    </el-form-item>
		<el-form-item label="限踢" prop="limitLower">
			<el-input v-model="dataForm.limitLower" placeholder="只能输入数字"></el-input>
		</el-form-item>
		<el-form-item label="限高" prop="limitHigh">
			<el-input v-model="dataForm.limitHigh" placeholder="只能输入数字"></el-input>
		</el-form-item>
    <el-form-item label="最高倍率" prop="maxTimes">
      <el-input v-model="dataForm.maxTimes" placeholder="只能输入数字"></el-input>
    </el-form-item>
    <el-form-item label="线数" prop="maxLines">
      <el-input v-model="dataForm.maxLines" placeholder="只能输入数字"></el-input>
    </el-form-item>
      ...
      return {
        ...
        dataRule: {
			...
			roomId: [
			  ...
			  limitHigh: [
				{ required: true,  validator: validateRate, message: '限高值不能为空并且只能输入数字', trigger: 'blur' }
			  ],
				limitLower: [
					{ required: true,  validator: validateRate, message: '限制踢出值不能为空并且只能输入数字', trigger: 'blur' }
				],
				onlineMin: [
			  ...
			  restrict: [
				{ required: true, validator: validateRate,message: '入场限制不能为空', trigger: 'blur' }
			  ],
// 					maintenance: [
...
//           maxTimes: [
//             { required: true, message: '最高倍率不能为空', trigger: 'blur' }
//           ],
//           maxLines: [
//             { required: true, message: '线数不能为空', trigger: 'blur' }
//           ]
        }
      }
    },
