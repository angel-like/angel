...
Date: 2019-08-30 16:04:31
*/

SET FOREIGN_KEY_CHECKS=0;

-- ----------------------------
-- Table structure for game_record_haochehui
-- ----------------------------
DROP TABLE IF EXISTS `game_record_haochehui`;
CREATE TABLE `game_record_haochehui` (
  ...
  `lottery_card` int(11) NOT NULL COMMENT '开奖牌型',
  `lottery_card_str` varchar(100) CHARACTER SET utf8 COLLATE utf8_general_ci NOT NULL DEFAULT '' COMMENT '开奖牌型字符',
...
) ENGINE=InnoDB AUTO_INCREMENT=3347 DEFAULT CHARSET=utf8 COMMENT='游戏记录-豪车会';
