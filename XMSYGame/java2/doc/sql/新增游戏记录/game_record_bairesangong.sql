...
Date: 2019-08-30 16:04:23
*/

SET FOREIGN_KEY_CHECKS=0;

-- ----------------------------
-- Table structure for game_record_bairesangong
-- ----------------------------
DROP TABLE IF EXISTS `game_record_bairesangong`;
CREATE TABLE `game_record_bairesangong` (
  ...
  `multiple_type` int(11) NOT NULL DEFAULT '1' COMMENT '倍数模式',
...
) ENGINE=InnoDB AUTO_INCREMENT=3346 DEFAULT CHARSET=utf8 COMMENT='游戏记录-百人三公';
