...
Date: 2019-08-02 10:18:52
*/

SET FOREIGN_KEY_CHECKS=0;

-- ----------------------------
-- Table structure for game_record_zhajinhua_fangka
-- ----------------------------
DROP TABLE IF EXISTS `game_record_zhajinhua_fangka`;
CREATE TABLE `game_record_zhajinhua_fangka` (
...
) ENGINE=InnoDB AUTO_INCREMENT=865 DEFAULT CHARSET=utf8 COMMENT='游戏记录-房卡炸金花';
