package com.xmsy.common.util.date;
...
public class SysDateUtils {
	...
	public static String getCurrentDate() {
		String datestr = null;
		SimpleDateFormat df = new SimpleDateFormat(SysDateUtils.DATE_FORMAT);
	...
	public static String getCurrentDateTime() {
		String datestr = null;
		SimpleDateFormat df = new SimpleDateFormat(SysDateUtils.DATE_TIME_FORMAT);
		datestr = df.format(new Date());
		return datestr;
	}
	...
	public static Date stringToDate(String datestr) {
		...
		try {
			...
			date = SysDateUtils.stringToDate(datestr, "yyyyMMdd");
		}
		return date;
	}
	...
	public static Date getLastDayOfMonth(Date date) {
		return SysDateUtils.addDay(SysDateUtils.getFirstDayOfMonth(SysDateUtils.addMonth(date, 1)), -1);
	}
	...
	public static long getDayByMinusDate(Object fromDate, Object toDate) {
		...
		Date f = SysDateUtils.chgObject(fromDate);

		Date t = SysDateUtils.chgObject(toDate);
	...
	public static int calcAge(Date birthday, Date calcDate) {
		...
		int cYear = SysDateUtils.getYearOfDate(calcDate);
		int cMonth = SysDateUtils.getMonthOfDate(calcDate);
		int cDay = SysDateUtils.getDayOfDate(calcDate);
		int bYear = SysDateUtils.getYearOfDate(birthday);
		int bMonth = SysDateUtils.getMonthOfDate(birthday);
		int bDay = SysDateUtils.getDayOfDate(birthday);
	...
	public static String getBirthDayFromIDCard(String idno) {
		...
		return SysDateUtils.dateToString(cd.getTime());
	}
	...
	public static Date chgObject(Object date) {
		...
		if (date != null && date instanceof String) {
			return SysDateUtils.stringToDate((String) date);
		}
	...
	public static void main(String[] args) {
		...
		long s = SysDateUtils.getDayByMinusDate("2012-01-01", "2012-12-31");
