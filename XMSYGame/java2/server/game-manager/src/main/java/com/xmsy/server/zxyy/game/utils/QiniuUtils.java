...
public class QiniuUtils {
	...
	public static String getUploadTokenPublic() throws NetworkErrorException {
		String accesskey = HallUrlConstant.QINIU_ACCESS_KEY;
		String secretkey = HallUrlConstant.QINIU_SECRET_KEY;
		String bucket = HallUrlConstant.QINIU_BUCKET_PULIC;
	...
	public static String uploadFile(MultipartFile file) throws Exception {
		...
		String url = HallUrlConstant.QINIU_URL + jsonObject.get("hash");// 七牛云路径
		return url;
	}
