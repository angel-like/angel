...
import com.xmsy.server.zxyy.game.modules.manager.sys.dao.SysRoleDao;
...
//        sysRoleMenuService.saveOrUpdate(role.getRoleId(), role.getMenuIdList());
	...
	private void checkUpdatePrems(SysRoleEntity role){
		...
		//查询用户所拥有的菜单列表
		List<Long> menuIdList = sysUserService.queryAllMenuId(entity.getCreateUserId());
		//判断是否越权
		if(!menuIdList.containsAll(role.getMenuIdList())){
			throw new RRException("所选权限不是该用户上级权限");
		}
	}
}
