...
import com.xmsy.server.zxyy.robot.common.validator.Assert;
...
import com.xmsy.server.zxyy.robot.modules.manager.sys.form.PasswordForm;
...
public class SysUserController extends AbstractController {
	...
	public R update(@RequestBody SysUserEntity user) {
		...
		if(user.getCreateUserId().equals(getUserId())) {
