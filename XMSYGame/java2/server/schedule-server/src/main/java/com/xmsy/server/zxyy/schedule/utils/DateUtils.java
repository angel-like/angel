...
public class DateUtils {
	...
	public static boolean isZero(Date date) {
		...
		return dateTime.getHourOfDay()==0;
	}
	 ...
	 * @return
	 */
	public static int differenceDay(Date sDate, Date eDate) {
		...
		if(eDate.after(sDate)) {
			...
			sDateTime = new DateTime(eDate);
			eDateTime = new DateTime(sDate);
		}
		int day1 = sDateTime.getDayOfYear();
		int day2 = eDateTime.getDayOfYear();
		int year1 = sDateTime.getYear();
		int year2 = eDateTime.getYear();
		if(year1==year2) {//同一年
			 return day2-day1;
		}else {//不同年
			 int timeDistance = 0 ;
	 ...
	 * @return
	 */
	public static Date addDayZeroPoint(Date date,int days) {
		Calendar cal = Calendar.getInstance();
		cal.setTime(date);
	...
	public static String getPastDate(int past) {
	 ...
	 System.out.println(formatTime(addDayZeroPoint(new Date(),1)));
	 System.out.println(formatTime(addDateHours(new Date(),-1)));
	 }
}
