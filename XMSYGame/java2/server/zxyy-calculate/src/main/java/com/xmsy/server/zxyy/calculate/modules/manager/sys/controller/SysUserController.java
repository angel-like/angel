...
import com.xmsy.server.zxyy.calculate.common.validator.Assert;
import com.xmsy.server.zxyy.calculate.common.validator.ValidatorUtils;
import com.xmsy.server.zxyy.calculate.common.validator.group.AddGroup;
import com.xmsy.server.zxyy.calculate.common.validator.group.UpdateGroup;
import com.xmsy.server.zxyy.calculate.modules.manager.sys.entity.SysRoleEntity;
import com.xmsy.server.zxyy.calculate.modules.manager.sys.entity.SysUserEntity;
import com.xmsy.server.zxyy.calculate.modules.manager.sys.entity.param.SysUserDetail;
import com.xmsy.server.zxyy.calculate.modules.manager.sys.form.PasswordForm;
import com.xmsy.server.zxyy.calculate.modules.manager.sys.service.SysRoleService;
import com.xmsy.server.zxyy.calculate.modules.manager.sys.service.SysUserRoleService;
import com.xmsy.server.zxyy.calculate.modules.manager.sys.service.SysUserService;
...
public class SysUserController extends AbstractController {
	...
	public R list(PageParam pageParam, SysUserDetail sysUserDetail) {
		...
		// 不显示代理商（代理商有专门的菜单栏）
//		Iterator<SysRoleEntity> it = sysRoles.iterator();
...
//		List<SysUserEntity> result = sysUserService.selectByMap(ImmutableMap.of("username", user.getUsername()));
//		if (CollectionUtils.isNotEmpty(result)) {
//			sysUserRoleService.saveOrUpdate(result.get(0).getUserId(), user.getRoleIdList());
//		}
		return R.ok();
	}
