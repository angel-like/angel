package com.xmsy.server.zxyy.calculate.modules.manager.usertransactionrecord.service.impl;
...
import com.xmsy.server.zxyy.calculate.modules.manager.usertransactionrecord.dao.UserTransactionRecordDao;
...
public class UserTransactionRecordServiceImpl extends ServiceImpl<UserTransactionRecordDao, UserTransactionRecordEntity>
	...
	public Page<UserTransactionRecordEntity> getTransactionRecords(UserTransactionRecordEntity record,
		...
		Page<UserTransactionRecordEntity> page = new Page<>(pageParam.getPage(), pageParam.getLimit());// 当前页，总条数 构造
																										// page 对象
