package com.xmsy.server.zxyy.webhome.modules.manager.rechargechannel.dao;
...
public interface RechargeChannelDao extends BaseMapper<RechargeChannelEntity> {
	 ...
	 * @return
	 */
	List<RechargeChannelResultEntity> selectChannelsByPayIdhierarchyId(@Param("id") Long id,@Param("hierarchyId") Long hierarchyId);
