package com.xmsy.server.zxyy.webhome.modules.manager.userpassword.service;
...
public interface UserPasswordService extends IService<UserPasswordEntity> {
	...
	void updateLoginPassWord2(String token, String verificationWord, String PassWord);
