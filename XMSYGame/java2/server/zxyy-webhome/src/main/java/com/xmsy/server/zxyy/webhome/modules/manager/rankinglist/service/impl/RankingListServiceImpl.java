package com.xmsy.server.zxyy.webhome.modules.manager.rankinglist.service.impl;
...
public class RankingListServiceImpl extends ServiceImpl<RankingListDao, RankingListEntity>
		implements RankingListService {
	...
	public PageUtils queryPage(Map<String, Object> params) {
		...
		Page<RankingListEntity> page = this.selectPage(new Query<RankingListEntity>(params).getPage(), wrapper);
	...
	@Override
	public List<RankingListUserVo> getImRankingListByYesterday(RankingListRequestVo vo) {
		return this.baseMapper.getImRankingListByYesterday(vo);
	}
