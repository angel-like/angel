package com.xmsy.server.zxyy.webhome.modules.manager.userbalancerecord.controller;
...
public class UserBalanceRecordController {
    ...
    public R list(UserBalanceRecordEntity userbalancerecord, PageParam pageParam){
		...
		Wrapper<UserBalanceRecordEntity> entityWrapper = new EntityWrapper<UserBalanceRecordEntity>(userbalancerecord);
