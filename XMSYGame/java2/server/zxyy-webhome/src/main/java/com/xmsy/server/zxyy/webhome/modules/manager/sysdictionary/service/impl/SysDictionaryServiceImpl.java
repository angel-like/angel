package com.xmsy.server.zxyy.webhome.modules.manager.sysdictionary.service.impl;
...
import com.xmsy.server.zxyy.webhome.modules.manager.sysdictionary.dao.SysDictionaryDao;
...
public class SysDictionaryServiceImpl extends ServiceImpl<SysDictionaryDao, SysDictionaryEntity>
	...
	@Override
	@Cacheable(cacheNames = EhCacheName.SYSDICTIONARY_CACHE, key = "#id", unless = "#result == null")
	...
	@Override
	@Cacheable(cacheNames = EhCacheName.SYSDICTIONARY_CACHE, key = "#parentCode", unless = "#result == null || #result.size() == 0")
