package com.xmsy.server.zxyy.webhome.modules.manager.apppopulargames.controller;
...
public class AppPopularGamesController {
	...
	public R list(AppPopularGamesEntity apppopulargames, PageParam pageParam) {
		...
		Wrapper<AppPopularGamesEntity> entityWrapper = new EntityWrapper<AppPopularGamesEntity>(apppopulargames);
