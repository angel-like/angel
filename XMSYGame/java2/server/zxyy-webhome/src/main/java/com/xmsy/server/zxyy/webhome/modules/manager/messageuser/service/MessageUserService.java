package com.xmsy.server.zxyy.webhome.modules.manager.messageuser.service;
...
public interface MessageUserService extends IService<MessageUserEntity> {
     ...
     * @param messageIds
     */
    List<Long> setReadBatch(String token);
    /**
     * 批量设置会员站内信删除
     * @param token
     * @param messageIds
     */
    List<Long> setDeleteBatch(String token);
    /**
     * 批量设置会员站内信删除
     * @param token
     * @param messageIds
	 ...
	 */
	Map<String,Object> receiveAllMessageProp(String token);
