package com.xmsy.server.zxyy.webhome.modules.manager.imcontact.controller;
...
public class ImContactController {
    ...
    public R list(ImContactEntity imcontact, PageParam pageParam){
		...
		Wrapper<ImContactEntity> entityWrapper = new EntityWrapper<ImContactEntity>(imcontact);
