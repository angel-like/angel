package com.xmsy.server.zxyy.webhome.modules.manager.gamerecordbairenniuniu.entity;
...
@TableName("game_record_bairenniuniu")
public class GameRecordBairenniuniuEntity extends BaseEntity<GameRecordBairenniuniuEntity> {
