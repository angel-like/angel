package com.xmsy.server.zxyy.webhome.modules.manager.useragenthierarchy.service.impl;
...
public class UserAgentHierarchyServiceImpl extends ServiceImpl<UserAgentHierarchyDao, UserAgentHierarchyEntity>
	...
	@Override
	@Cacheable(cacheNames = EhCacheName.USER_AGENT_HIERARCHY_CACHE, key = "#id", unless = "#result == null")
	...
	@Override
	@Cacheable(cacheNames = EhCacheName.USER_AGENT_HIERARCHY_CACHE, key = "'defaultAgentHierarchy'", unless = "#result == null")
