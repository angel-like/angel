package com.xmsy.server.zxyy.webhome.modules.manager.cashqrcode.dao;
...
public interface CashQrcodeDao extends BaseMapper<CashQrcodeEntity> {
	...
	List<Map<String, Object>> findCashQrcodeTypeByHierarchyId(@Param("hierarchyId") Long hierarchyId);
