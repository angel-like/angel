package com.xmsy.server.zxyy.webhome.modules.manager.cashqrcode.service.impl;
...
import com.xmsy.server.zxyy.webhome.modules.manager.cashqrcode.dao.CashQrcodeDao;
...
public class CashQrcodeServiceImpl extends ServiceImpl<CashQrcodeDao, CashQrcodeEntity> implements CashQrcodeService {
	...
	@Override
	public List<Map<String, Object>> findCashQrcodeTypeByHierarchyId(Long hierarchyId) {
		return baseMapper.findCashQrcodeTypeByHierarchyId(hierarchyId);
	}
