package com.xmsy.server.zxyy.webhome.modules.app.userquestion.controller;
...
public class UserQuestionController {
    ...
    public R list(UserQuestionEntity entity, PageParam pageParam){
        ...
        Wrapper<UserQuestionEntity> entityWrapper = new EntityWrapper<UserQuestionEntity>(entity);
