package com.xmsy.server.zxyy.webhome.modules.manager.userbalancerate.controller;
...
public class UserBalanceRateController {
    ...
    public R list(UserBalanceRateEntity userbalancerate, PageParam pageParam){//
        /*Page<UserBalanceRateEntity> result = new Page<UserBalanceRateEntity>(pageParam.getPage(), pageParam.getLimit());
		Wrapper<UserBalanceRateEntity> entityWrapper = new EntityWrapper<UserBalanceRateEntity>(userbalancerate);
		entityWrapper.orderBy(pageParam.getSort(), pageParam.getDirection());
		userbalancerate.selectPage(result, entityWrapper);
