package com.xmsy.server.zxyy.webhome.modules.manager.ordercashexamine.service.impl;
	...
	public OrderCashExamineEntity updateCashExamineForRecharge(UserEntity user, UserHierarchyEntity hierarchyEntity,
		...
		while (i < 10) {
			...
			BigDecimal userValidBetDecimal = new BigDecimal(userValidBet == null ? 0 : userValidBet)
					.divide(new BigDecimal(Constant.COIN_RATE),2, BigDecimal.ROUND_DOWN)
					.add(orderCashExamineEntity.getUserValidBet());
			userValidBetDecimal = userValidBetDecimal.compareTo(BigDecimal.ZERO)<0 ? BigDecimal.ZERO : userValidBetDecimal;
