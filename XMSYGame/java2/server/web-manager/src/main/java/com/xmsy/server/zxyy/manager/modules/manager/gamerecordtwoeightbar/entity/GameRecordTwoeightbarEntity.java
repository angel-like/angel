package com.xmsy.server.zxyy.manager.modules.manager.gamerecordtwoeightbar.entity;
...
@TableName("game_record_twoeightbar")
public class GameRecordTwoeightbarEntity extends BaseEntity<GameRecordTwoeightbarEntity> {
