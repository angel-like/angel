package com.xmsy.server.zxyy.manager.modules.manager.proxytransferrecord.controller;
...
public class ProxyTransferRecordController extends AbstractController{
    @Autowired
    ...
    public R list(ProxyTransferRecordEntity proxytransferrecord, PageParam pageParam){
    	...
    	if (sysUser.getRoleIds().equals(SysConstant.PROXYID)) {
    		proxytransferrecord.setProxyId(sysUser.getUserId());
		}
