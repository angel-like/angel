package com.xmsy.server.zxyy.manager.modules.manager.gamerecordxuezhanmajiang.controller;
...
public class GameRecordXuezhanmajiangController {
    ...
    public R list(GameRecordXuezhanmajiangEntity gamerecordxuezhanmajiang, PageParam pageParam){
		...
		entityWrapper.ge(!StringUtils.isBlank(gamerecordxuezhanmajiang.getStartTime()), "create_time", gamerecordxuezhanmajiang.getStartTime());
		entityWrapper.le(!StringUtils.isBlank(gamerecordxuezhanmajiang.getEndTime()), "create_time", gamerecordxuezhanmajiang.getEndTime());
		...
		for(GameRecordXuezhanmajiangEntity data:result.getRecords()) {
	        data.setSettlementCard(data.getSettlementCard().replace("#", "\r\n"));
		}
