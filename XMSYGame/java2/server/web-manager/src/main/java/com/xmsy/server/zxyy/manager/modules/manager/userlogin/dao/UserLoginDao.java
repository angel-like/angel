package com.xmsy.server.zxyy.manager.modules.manager.userlogin.dao;
...
public interface UserLoginDao extends BaseMapper<UserLoginEntity> {
	...
	Map<String, Object> getUserLoginByUserId( @Param("userId") Long userId, @Param("token") String token);
}
