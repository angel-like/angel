package com.xmsy.server.zxyy.manager.modules.manager.roomcardproxy.controller;
...
import com.xmsy.server.zxyy.manager.modules.manager.roomcardproxy.entity.RoomCardProxyEntity;
import com.xmsy.server.zxyy.manager.modules.manager.roomcardproxy.service.RoomCardProxyService;
...
public class RoomCardProxyController {
    ...
    public R list(RoomCardProxyEntity roomcardproxy, PageParam pageParam){
		...
		Wrapper<RoomCardProxyEntity> entityWrapper = new EntityWrapper<RoomCardProxyEntity>(roomcardproxy).orderBy("sort");
    ...
    public R update(@RequestBody RoomCardProxyEntity roomcardproxy){
			roomCardProxyService.updateAllColumnById(roomcardproxy);
        return R.ok();
    }
