package com.xmsy.server.zxyy.manager.modules.manager.gamerecordpaijiu.service.impl;
...
import com.xmsy.server.zxyy.manager.modules.manager.gamerecordpaijiu.dao.GameRecordPaijiuDao;
	...
	public void appSaveGameRecord(BairenpaijiuGameRecordParams bairenpaijiuGameRecordParams) {
		...
		for (BairenBetUserRecordParams userRecord : bairenpaijiuGameRecordParams.getUserRecord()) {
			...
			gameRecord.setUserId(userRecord.getUserId()).setUserAccount(userRecord.getUserAccount())
					...
					.setIdleCard(stringBuilderIdleCard.toString()).setIdleCardStr(stringBuilderIdleCardStrStr.toString())
