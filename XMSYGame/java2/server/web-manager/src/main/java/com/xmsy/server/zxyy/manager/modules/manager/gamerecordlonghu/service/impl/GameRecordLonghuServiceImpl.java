package com.xmsy.server.zxyy.manager.modules.manager.gamerecordlonghu.service.impl;
...
import com.xmsy.server.zxyy.manager.modules.manager.gamerecordlonghu.dao.GameRecordLonghuDao;
	...
	public void appSaveGameRecord(LongHuGameRecordParams longHuGameRecordParams) {
		...
		for (BairenBetUserRecordParams userRecord : longHuGameRecordParams.getUserRecord()) {
			...
			for (int i = 0; i < betAreaArray.size(); i++) {
				...
				stringBuilder.append(betAreaArray.get(i));
				stringBuilder.append(",");
			}
