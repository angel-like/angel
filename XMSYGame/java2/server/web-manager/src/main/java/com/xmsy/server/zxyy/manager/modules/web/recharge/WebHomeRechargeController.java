// package com.xmsy.server.zxyy.manager.modules.web.recharge;
//
...
// import com.xmsy.network.pay.paybase.define.PayChannel;
// import com.xmsy.network.pay.paybase.define.PayPlatform;
// import com.xmsy.network.pay.paybase.param.PayParam;
// import com.xmsy.network.pay.paybase.pay.impl.PayService;
// import com.xmsy.network.pay.paybase.result.PayResult;
// import com.xmsy.network.pay.paybase.utils.PayResultUtil;
// import com.xmsy.server.zxyy.manager.common.annotation.RechargeOrderRepeat;
...
// import com.xmsy.server.zxyy.manager.common.utils.CreateQRCode;
...
// import
// com.xmsy.server.zxyy.manager.modules.manager.cashbank.entity.CashBankEntity;
// import
// com.xmsy.server.zxyy.manager.modules.manager.cashbank.service.CashBankService;
// import
// com.xmsy.server.zxyy.manager.modules.manager.cashqrcode.entity.CashQrcodeEntity;
// import
// com.xmsy.server.zxyy.manager.modules.manager.cashqrcode.service.CashQrcodeService;
// import
// com.xmsy.server.zxyy.manager.modules.manager.orderbankrecharge.entity.OrderBankRechargeEntity;
// import
// com.xmsy.server.zxyy.manager.modules.manager.orderrecharge.entity.OrderRechargeEntity;
// import
// com.xmsy.server.zxyy.manager.modules.manager.orderrecharge.service.OrderRechargeService;
// import
// com.xmsy.server.zxyy.manager.modules.manager.payconfig.entity.PayConfigFirstEntity;
// import
// com.xmsy.server.zxyy.manager.modules.manager.payconfig.entity.PayConfigResultEntity;
// import
// com.xmsy.server.zxyy.manager.modules.manager.payconfig.service.PayConfigService;
// import
// com.xmsy.server.zxyy.manager.modules.manager.rechargechannel.entity.RechargeChannelResultEntity;
// import
// com.xmsy.server.zxyy.manager.modules.manager.rechargechannel.service.RechargeChannelService;
// import
// com.xmsy.server.zxyy.manager.modules.manager.sys.service.SysCaptchaService;
// import
// com.xmsy.server.zxyy.manager.modules.manager.sysdictionary.service.SysDictionaryService;
...
// import
// com.xmsy.server.zxyy.manager.modules.web.recharge.param.QrCodeRechargeParam;
// import
// com.xmsy.server.zxyy.manager.modules.web.recharge.param.QrcodePaymentParam;
...
// public R qrcodeRecharge(@RequestBody @Valid QrcodePaymentParam paymentParam,
...
// return R.ok().put("qrcode", qrcode).put("orderNo",
// payResult.getData().getOrderNo());
// }
//
// /**
// * 移动端充值返回一个支付链接
...
// public R urlRecharge(@RequestBody @Valid QrcodePaymentParam paymentParam,
// HttpServletRequest httpServletRequest)
// throws Exception {
// payConfigService.valitePayConfig(paymentParam);
// PayResult payResult = rechargeForThird(paymentParam, httpServletRequest,
...
// }
// return R.ok().put("qrcode",
// cashQrcodeService.findCashQrcodeByHierarchyId(userEntity.getHierarchyId(),
// type));
// }
//
// /**
...
// return R.ok().put("status", orderRechargeEntity.getStatus() ==
...
// log.info("官网银行存款 saveRechargeBank：orderBankRechargeEntity {}",
// orderBankRechargeEntity);
// String ip = IpUtil.getIPAddress(httpServletRequest);
// String token = httpServletRequest.getHeader("token");// 获取人员token
// Long userId = Long.valueOf(JwtUtil.getUserId(token));// 通过token获取人员ID
...
// 存款后的余额+金币
// orderRecharge.setFinalMoney(userEntity.getMoney().add(new
// BigDecimal(orderBankRechargeEntity.getAmount())));
// orderRecharge.setHierarchyId(userEntity.getHierarchyId()); // 用户层级
...
// * @throws Exception
// */
// private PayResult rechargeForThird(QrcodePaymentParam paymentParam,
// HttpServletRequest httpServletRequest,
...
// ErrorCode.UserErrorCode.USER_TRIAL_ERRO.getCode());
// }
// if (isCheckCode && !sysCaptchaService.validate(paymentParam.getCaptchaUuid(),
// paymentParam.getCode())) {
// throw new
// RRException(ErrorCode.InvitationCodeErrorCode.RECOMMENDATION_CODE_ISNULL.getErrMsg(),
...
// param.setPlatform(PayPlatform.PC);
// param.setOrderIp(ip);
...
// .setRemark(paymentParam.getRemark()).setRechargePlatform(String.valueOf(payService.getValue()))
...
// List<PayConfigFirstEntity> list =
// rechargeChannelService.selectFirstRecommendForWeb();
...
// public R paymentMethodForWeb(@RequestParam Long payId, @RequestParam Long
// amount) {
// log.info("[paymentMethodForWeb] payId {} amount {}", payId, amount);
// List<RechargeChannelResultEntity> rechargeChannels =
// rechargeChannelService.selectChannelsByPayId(payId);
...
// }
// List<RechargeChannelResultEntity> rechargeChannelResult =
// Lists.newArrayList();
// List<Long> list = Lists.newArrayList();
// for (RechargeChannelResultEntity rechargeChannel : rechargeChannels) {
// if (amount <= rechargeChannel.getHighLimit() && amount >=
// rechargeChannel.getLowLimit()) {
...
// throw new RRException("[最小支付金额" + list.get(0) + ",最大支付金额" +
