package com.xmsy.server.zxyy.manager.modules.manager.gamerecordpaijiu.entity;
...
@TableName("game_record_bairenpaijiu")
public class GameRecordPaijiuEntity extends BaseEntity<GameRecordPaijiuEntity> {
