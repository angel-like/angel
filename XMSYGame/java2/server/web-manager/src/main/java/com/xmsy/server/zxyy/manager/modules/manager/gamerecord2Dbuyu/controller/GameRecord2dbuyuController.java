package com.xmsy.server.zxyy.manager.modules.manager.gamerecord2Dbuyu.controller;
...
public class GameRecord2dbuyuController {
    ...
    public R list(GameRecord2dbuyuEntity gamerecord2dbuyu, PageParam pageParam){
		...
		entityWrapper.ge(!StringUtils.isBlank(gamerecord2dbuyu.getStartTime()),"create_time", gamerecord2dbuyu.getStartTime());
		entityWrapper.le(!StringUtils.isBlank(gamerecord2dbuyu.getEndTime()),"create_time", gamerecord2dbuyu.getEndTime());
