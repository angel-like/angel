package com.xmsy.server.zxyy.manager.modules.manager.rankinglistday.service.impl;
...
import com.xmsy.server.zxyy.manager.modules.manager.rankinglistday.dao.RankingListDayDao;
import com.xmsy.server.zxyy.manager.modules.manager.rankinglistday.entity.RankingListDayEntity;
import com.xmsy.server.zxyy.manager.modules.manager.rankinglistday.service.RankingListDayService;
...
public class RankingListDayServiceImpl extends ServiceImpl<RankingListDayDao, RankingListDayEntity> implements RankingListDayService {
    ...
    public PageUtils queryPage(Map<String, Object> params) {
    	...
    	if(params !=null) {
    		...
    		if(params.get("startTime")!=null && !"".equals(params.get("startTime").toString().trim())){
    			entity.setStartTime(params.get("startTime").toString().trim());
    		}
    		if(params.get("endTime")!=null && !"".equals(params.get("endTime").toString().trim())){
    			entity.setEndTime(params.get("endTime").toString().trim());
    		}
    	}
    	...
    	if(entity.getStartTime()!=null&& !"".equals(entity.getStartTime())) {
    		wrapper.ge("that_day",DateUtils.format(DateUtils.stringToDate(entity.getStartTime(),DateUtils.DATE_TIME_PATTERN)));
    	}
    	if(entity.getEndTime()!=null&& !"".equals(entity.getEndTime())) {
        	wrapper.le("that_day",DateUtils.format(DateUtils.stringToDate(entity.getEndTime(),DateUtils.DATE_TIME_PATTERN)));
    	}
