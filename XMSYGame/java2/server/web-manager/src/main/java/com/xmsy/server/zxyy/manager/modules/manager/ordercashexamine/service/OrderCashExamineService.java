package com.xmsy.server.zxyy.manager.modules.manager.ordercashexamine.service;
...
public interface OrderCashExamineService extends IService<OrderCashExamineEntity> {
	 ...
	 * @param orderRechargeEntity
	 * @param user
	 * @param discountMultiple
	 * @param rechargeMultiple
	 * @return
	 * @throws Exception
	 */
	BigDecimal saveCashExamine(OrderRechargeEntity orderRechargeEntity, UserEntity user,BigDecimal discountMultiple
	...
	boolean updateCashBetAndTime(Long userId,BigDecimal userValidBet,Date updateTime);
