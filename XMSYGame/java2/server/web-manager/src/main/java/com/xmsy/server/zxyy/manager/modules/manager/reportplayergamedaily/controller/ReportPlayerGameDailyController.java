package com.xmsy.server.zxyy.manager.modules.manager.reportplayergamedaily.controller;
...
import com.xmsy.server.zxyy.manager.modules.manager.reportplayergamedaily.service.ReportPlayerGameDailyService;
...
public class ReportPlayerGameDailyController {
	...
	@RequiresPermissions("reportplayergamedaily:reportplayergamedaily:list")
	public R sceneList(PageParam pageParam, @RequestParam(required = false, value = "startTime") String startTime,
			@RequestParam(required = false, value = "endTime") String endTime,GameRecordEntity gameRecord) {
		Page<GameRecordEntity> result = gameRecordService.queryField(pageParam, gameRecord.getCountDay(),startTime,endTime,
