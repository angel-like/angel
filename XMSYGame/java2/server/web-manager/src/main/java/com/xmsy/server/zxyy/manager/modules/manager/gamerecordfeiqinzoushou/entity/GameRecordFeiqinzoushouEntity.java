package com.xmsy.server.zxyy.manager.modules.manager.gamerecordfeiqinzoushou.entity;
...
@TableName("game_record_feiqinzoushou")
public class GameRecordFeiqinzoushouEntity extends BaseEntity<GameRecordFeiqinzoushouEntity> {
